...
public class Board {
    ...
    public Boolean isInFavorOfX() {
        for(int i = 0; i < ticBoard.length; i++){
            if(ticBoard[i][0] == 'X' && ticBoard[i][1] == 'X' && ticBoard[i][2] == 'X'){
                return true;
        }
        ...
        if(ticBoard[0][2] == 'X' && ticBoard[1][1] == 'X' && ticBoard[2][0] == 'X'){
            return true;
        }
        return false;
    }
    ...
    public Boolean isInFavorOfO() {
        for(int i = 0; i < ticBoard.length; i++){
            if(ticBoard[i][0] == 'O' && ticBoard[i][1] == 'O' && ticBoard[i][2] == 'O'){
                return true;
            }
        ...
        if(ticBoard[0][0] == 'O' && ticBoard[1][1] == 'O' && ticBoard[2][2] == 'O'){
            return true;
        }
